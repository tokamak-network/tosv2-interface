  ...
  return (
    ...
    >
      ...
      <Flex>
        ...
        >
          <Image
            src={account ?colorMode === 'light'? WALLETLIGHT_ICON : WALLETDARK_ICON :  colorMode === 'light'? WALLETLIGHT_INACTIVE_ICON: WALLETDARK_INACTIVE_ICON}
            alt={"WALLET_ICON"}
          ></Image>
          <Text w={"127px"} color={account ? colorMode === 'light'?  "#16161e" : "#f1f1f1" : colorMode === 'light'? '#7e7e8f':'#707070'}>
            {account
              ? trimAddress({
                  address: account,
                  firstChar: 7,
        ...
        >
          <Image src={colorMode ==='light'? SUN_ICON : MOON_ICON} alt={"MOON_ICON"}></Image>
        </Flex>
      </Flex>
    </Flex>
  );
